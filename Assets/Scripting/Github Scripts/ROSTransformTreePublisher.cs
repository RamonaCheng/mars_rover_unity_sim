...
//         {
//             var tfRootToGlobal = m_TransformRoot.Transform.ToROSTransformStamped(Clock.time);
//             tfRootToGlobal.header.frame_id = m_GlobalFrameIds.Last();
...
//         // Debug.Log("tf Message List 1: " + tfMessageList);
...
//             // Debug.Log("tf Message List 1: " + m_GlobalFrameIds[i - 1] +  m_GlobalFrameIds[i]);
//         }

//         // Debug.Log("tf Message List 2: " + tfMessageList);
//         PopulateTFList(tfMessageList, m_TransformRoot);
//         //  Debug.Log("tf Message List 3: " + tfMessageList);
//         //   Debug.Log("---------------------\n");
