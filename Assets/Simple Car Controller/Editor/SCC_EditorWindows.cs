...
public class SCC_EditorWindows : Editor {
    ...
    public static void CreateCamera() {
        ...
        if (!Object.FindFirstObjectByType<SCC_Camera>()) {
            ...
            Selection.activeGameObject = Object.FindFirstObjectByType<SCC_Camera>().gameObject;
    ...
    public static void CreateCanvas() {
        ...
        if (!Object.FindFirstObjectByType<SCC_Dashboard>()) {
            ...
            Selection.activeGameObject = Object.FindFirstObjectByType<SCC_Dashboard>().gameObject;
